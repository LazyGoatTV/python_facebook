...
from ....utils.constant import APPLICATION_PUBLIC_FIELDS, APPLICATION_ACCOUNT_PUBLIC_FIELDS
from ...base_resource import BaseResource
from ....models.application import Application, ApplicationAccountsResponse
...
class FacebookApplication(BaseResource):
    def get_info(
        ...
        """
        if fields is None:
            fields = APPLICATION_PUBLIC_FIELDS
    ...
    def get_accounts(
        ...
        if fields is None:
            fields = APPLICATION_ACCOUNT_PUBLIC_FIELDS
