...
from ...facebook.common_edges import (
    FeedEdge,
    AlbumsEdge,
    PhotosEdge,
    VideosEdge,
...
from ....models.page import Page, SearchPagesResponse
from ....models.post import FeedResponse
...
class FacebookPage(
    ...
    def search(
        ...
        """
        if fields is None:
            fields = SEARCH_PAGES_PUBLIC_FIELDS
