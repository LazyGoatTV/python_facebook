...
from ....models.ig_business_models import (
    IgBusUser,
    IgBusMediaResponse,
...
class IGBusinessUser(BaseResource):
    def get_info(
        ...
        """
        if fields is None:
            fields = IG_BUSINESS_USER_PUBLIC_FIELDS
    ...
    def discovery_user_medias(
        ...
        if fields is None:
            fields = IG_BUSINESS_MEDIA_PUBLIC_FIELDS
        metric = enf_comma_separated(field="fields", value=fields)
    ...
    def get_content_publishing_limit(
        ...
        if fields is None:
            fields = IG_BUSINESS_CONTENT_PUBLISH_LIMIT_FIELDS
    ...
    def get_mentioned_comment(
        ...
        if fields is None:
            fields = IG_BUSINESS_COMMENT_PUBLIC_FIELDS
    ...
    def get_mentioned_media(
        ...
        if fields is None:
            fields = IG_BUSINESS_MENTION_MEDIA_FIELDS
        fields_inline = enf_comma_separated(field="fields", value=fields)
    ...
    def get_recently_searched_hashtags(
        ...
        if fields is None:
            fields = IG_BUSINESS_HASHTAG_PUBLIC_FIELDS
